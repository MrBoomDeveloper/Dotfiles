...
hl.animation({ leaf = "workspacesIn", enabled = true, speed = 1.5, bezier = "default", style = "slide" })
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 1.5, bezier = "default", style = "slide" })
